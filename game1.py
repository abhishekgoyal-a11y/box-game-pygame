...
def button(msg, x, y, w, h, ic, ac, text_x, text_y, action):
    ...
    all_font = pygame.font.SysFont('comicsansms', 15)
...
def paused():
    ...
    while pause:
        ...
        game_start_font = pygame.font.SysFont('comicsansms', 30)
        game_start_x = 200
        game_start_y = 80
...
def gameover():
    pygame.mixer.music.pause()
    gameover_font = pygame.font.SysFont('comicsansms', 50)
...
def game_loop():
    ...
    while loop:
        ...
        if live == 0:
            ...
            player_y = -300
        # enemy
        pygame.draw.rect(game_display, enemy_color, (enemy_x, enemy_y, 80,80))
